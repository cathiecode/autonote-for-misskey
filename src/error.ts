...
export const NO_SUCH_MI_AUTH_SESSION = "NO_SUCH_MI_AUTH_SESSION";
export const MISSKEY_INSTANCE_CONNECTION_ERROR = "MISSKEY_INSTANCE_CONNECTION_ERROR";
export const MIAUTH_DENIED = "MIAUTH_DENIED";
export const UNKNOWN_VALIDATION_ERROR = "UNKNOWN_VALIDATION_ERROR";
